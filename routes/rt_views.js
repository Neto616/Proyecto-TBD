...
const ini = require('../controllers/controllers_views/iniciar');
const con = require('../controllers/controllers_views/ctrl_olvidarC');
const router = express.Router()

//login
router.get('/', index.inicio);
router.get('/iniciar', ini.log);
router.get('/olvidar-contrasena', con.contraseña);
